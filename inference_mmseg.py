...
def parse_args():
    ...
    parser.add_argument('root_test_dir', help='path of test data')
    parser.add_argument('work_dir', help='directory path which contains pth file')
    parser.add_argument('test_json_path',help='path of test.json')
